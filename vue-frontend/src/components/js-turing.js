...
export const RunButton = function ()
{
...
export const AboutMenuClicked = function ( name )
{
...
/* for testing */
export const testsave = function ( success )
{
	if( success ) {
...
export const repeat = function ( c, n )
{
	var sTmp = "";
	while( n-- > 0 ) sTmp += c;
	return sTmp;
...
export const debug = function ( n, str )
{
	if( n <= 0 ) {
